            ...
            <div class="form">
                ...
                if(isset($_POST['tim']))
                {
                    ...
                    if (!$tentk  )
                    {
                        ...
                        if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM taikhoan WHERE tentk='$tentk' and level =2")) > 0)
                        {
                            ...
                            <?php
                               $sql = mysqli_query($conn,"SELECT * FROM taikhoan WHERE tentk='$tentk' and level = 2");
                ...
                if(isset($_POST['xoa'])){
                    $tentk   = $_POST['tentk'];                    
                    mysqli_query($conn,"delete from taikhoan where tentk='$tentk' and level =2") or die(mysqli_error($conn));
