...
<div class="title col-md-12"> 
           ...
           <div class="content">  
            ...
            <h3 style="text-align:center">Danh sách tài khoản quản lý</h3>
            <br><br>
            <div class="form" style="  margin-left: 20%; ">
  
                <?php 
                
                        if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM taikhoan where level = 2")) > 0)                  
                        {   
                            ?>
                            <br>
                            <br>
                            ...
                            <?php
                             $sql = mysqli_query($conn,"SELECT * FROM taikhoan where level = 2");
                             while($row = mysqli_fetch_assoc($sql))
                             {
                                $sql1 = mysqli_query($conn,"SELECT * FROM taikhoan where level = 2");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="suatkquanly.php?matk=<?php echo $row['matk'];  ?>">Sửa</a></td>
                                </tr> 
                               <?php 
                                       } ?>
                                </table>
                ...
                <a href="xoatkquanly.php"><input type="button" value="Xóa tài khoản"></a>
