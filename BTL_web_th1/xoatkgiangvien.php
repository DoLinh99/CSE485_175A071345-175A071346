            ...
            <div class="form">
                ...
                if(isset($_POST['tim']))
                {
                    ...
                    if (!$tentk  )
                    {
                        ...
                        if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM taikhoan WHERE tentk='$tentk' and level =0")) > 0)
                        {
                            ...
                            <?php
                               $sql = mysqli_query($conn,"SELECT * FROM taikhoan WHERE tentk='$tentk' and level = 0 ");
