           ...
           <div class="content">  
            ...
            <div class="form" style="  margin-left: 20%; ">
                ...
                <?php 
                        ...
                        if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM taikhoan where level = 1")) > 0)                  
                        {   
                            ?>
                            <br>
                            <br>
                            ...
                            <?php
                             $sql = mysqli_query($conn,"SELECT * FROM taikhoan where level = 1");
                             while($row = mysqli_fetch_assoc($sql))
                             {
                                $sql1 = mysqli_query($conn,"SELECT * FROM taikhoan where level = 1");
