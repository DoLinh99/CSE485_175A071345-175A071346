        ...
        <div class="ad_logout col-md-5">
           ...
           <div class="content">  
               ...
               <ul>
                  <li class="nav-item1">
                    ...
                    <li class="nav-item dropdown">
                     ...
                     <!-- <li class="nav-item dropdown">
                       <a class="nav-link dropdown-toggle" href="themdiem.php" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <i class="fa fa-list">Điểm</i> 
                       </a>
</li><hr> -->
               </ul>
             ...
             <form  method="post">
                    ...
                    <div class="content-right">
                        ...
                        while($row1 = mysqli_fetch_assoc($sql1))
                        {
                         ?>
                            ...
                            <option value='<?php echo $row1['mamon']; ?>'><?php echo $row1['tenmon']; ?></option>
                            
                        
                        <?php } ?>
                        </select>
                        <input type="submit" value="Hiển thị lớp học phần" name="hienthi">
                    <br><br>
            </form>
                <?php 
                ...
                <?php
                    $sql = mysqli_query($conn,"SELECT masv,tensv,ngaysinh,makhoahoc from sinhvien where mamon='$mamon'");  
