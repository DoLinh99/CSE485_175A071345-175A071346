...
<div id="header">
 ...
 -->
                    ...
                    <div>
                    <h1 style="margin-left:300px">SỬA THÔNG TIN SINH VIÊN</h1>
                    </div>
                ...
                <td><select name="khoahoc">
                        <option  value="1">K61</option>
                        <option  value="2">K60</option>
                        <option  value="3">K59</option>
                        <option  value="4">K58</option>
                </select>
                </td>
							</tr>
							<tr>
								<td>Quyền</td>
                <td><select name="taikhoan">
                        <option  value="a">Giảng viên</option>
                        <option  value="b">Quản lý</option>
                        <option  value="c">Quản trị</option>                
                      </select>
                </td>
							</tr>
							<tr>
